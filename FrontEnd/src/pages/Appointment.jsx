  ...
  return (
    docInfo && (
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-400 mb-5 mt-2">
          <span
            onClick={() => navigate("/")}
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-3xl shadow-xl border border-gray-100 bg-[#EEF2FF]">
              ...
              <div className="absolute top-4 left-4">
                <span
                  className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold backdrop-blur-md shadow-lg ${docInfo.available ? "bg-green-500/95 text-white" : "bg-red-500/95 text-white"}`}
                >
          ...
          <div className="bg-white rounded-3xl border border-gray-200 shadow-lg p-6 sm:p-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-5">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white px-5 py-3 rounded-full font-semibold shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300"
              >
                <svg
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-wrap gap-2">
                {getSpecialities(docInfo.speciality).length > 0 ? (
                  getSpecialities(docInfo.speciality).map(
                    (speciality, index) => (
                      <span
                        key={index}
                        className="px-3 py-1.5 rounded-full bg-[#F1F5FF] text-[#0b2149] border border-[#DCE5FF] text-xs font-semibold hover:bg-[#0b2149] hover:text-white transition-all duration-200"
                      >
                        {speciality}
                      </span>
                    ),
            ...
            <div className="mt-6 bg-gradient-to-r from-[#F8FAFF] to-[#EEF3FF] border border-[#DCE5FF] rounded-2xl p-4 flex items-center justify-between">
              ...
              <div className="text-right mb-2">
                <p className="text-xs text-gray-400">Total Consultation time</p>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl shadow-sm p-5">
              ...
              {docSlots.map((item, index) => {
                ...
                return (
                  <button
                    ...
                    className={`min-w-[76px] h-[88px] rounded-2xl flex flex-col items-center justify-center border transition-all duration-300 ${selected ? "bg-[#0b2149] text-white border-[#0b2149] shadow-lg scale-105" : "bg-white text-gray-600 border-gray-200 hover:border-[#0b2149] hover:bg-[#F8FAFF]"}`}
                  >
                ...
                {docSlots[slotIndex]?.map((item, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-4 py-2.5 rounded-xl text-sm font-medium border transition-all duration-200 ${selected ? "bg-[#0b2149] text-white border-[#0b2149] shadow-md" : "bg-white text-gray-600 border-gray-200 hover:border-[#0b2149] hover:text-[#0b2149]"}`}
                    >
                      {item.time}
                    </button>
                  );
            ...
            <div className="mt-8">
              <button
                ...
                disabled={!slotTime}
                className={`w-full sm:w-auto px-10 py-3.5 rounded-xl font-semibold text-sm transition-all duration-300 ${slotTime ? "bg-[#0b2149] hover:bg-[#071832] text-white shadow-lg hover:shadow-xl hover:-translate-y-0.5" : "bg-gray-200 text-gray-400 cursor-not-allowed"}`}
              >
        ...
        <div className="mt-6">
          <FAQ docId={docId} speciality={docInfo.speciality} />
        </div>
