...
const AddDoctor = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#F5F7FB] p-4 md:p-8">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-[#0b2149]">Add Lawyer</h1>

        <p className="text-gray-500 mt-2">
          Register a professional legal expert to the NyaySetu platform.
        </p>
      </div>
      ...
      <form
        ...
        className="bg-white rounded-3xl shadow-lg border border-gray-100 p-6 md:p-10 max-w-6xl"
      >
        {/* Upload Image */}
        ...
        <div className="mt-8">
          ...
          <textarea
            ...
            value={about}
            rows={6}
            placeholder="Write professional information about the lawyer..."
            required
